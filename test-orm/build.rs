...
fn compile(
    ...
    config
        ...
        .protoc_arg("grpc_api_configuration=proto/api_config_http.yaml,output_format=yaml,allow_merge=true,merge_file_name=test")
        .bytes(["."])
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    compile(&["proto/test.proto"], &["proto"], gens)?;
    Ok(())
}
